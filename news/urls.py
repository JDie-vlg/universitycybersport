...
urlpatterns = [
    ...
    path('users/change_profile/<slug>/', ProfileUpdate.as_view(), name='user_change'),
    ...
    path('change_team/<slug:slug>/', TeamUpdate.as_view(), name='team_change'),
    ...
    path('tournament_registration/<int:tournament_id>/', TournamentsRegistration.as_view(),
